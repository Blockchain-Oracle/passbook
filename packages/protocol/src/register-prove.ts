...
// Re-exported for the callers that always found the span helpers here.
export { decodeClientActions, extractClientActionSpan, type DecodedAction } from './action-span.js'
