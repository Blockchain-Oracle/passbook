...
export function Page({ kicker, title, description, actions, className, headerClassName, children }: PageProps) {
  return (
    ...
    <div className={cn('@container mx-auto flex w-full min-w-0 max-w-5xl flex-col gap-6 px-4 py-4 md:px-8 md:py-6', className)}>
      ...
      <header className={cn('flex flex-wrap items-start justify-between gap-x-4 gap-y-3', headerClassName)}>
